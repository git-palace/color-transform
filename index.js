...
ColorTransform.rgb2cmyk = function(data) {
  var res = new Buffer((data.length / 3 | 0) * 4);
  var i = 0, j = 0;
  ...
  while (data.length - i >= 3) {
    ...
    var [_r, _g, _b] = [r / 255, g / 255, b / 255];
    ...
    c = Math.round(255 - (255 * c));
    m = Math.round(255 - (255 * m));
    y = Math.round(255 - (255 * y));
    k = Math.round(255 - (255 * k));
...
// TODO: rgba2cmyk
ColorTransform.rgba2cmyk = function(data) {
  return ColorTransform.rgb2cmyk(ColorTransform.rgba2rgb(data));
}
